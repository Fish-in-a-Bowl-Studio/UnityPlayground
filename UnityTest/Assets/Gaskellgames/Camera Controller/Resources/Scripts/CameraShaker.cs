...
namespace Gaskellgames.CameraController
{
    public class CameraShaker : MonoBehaviour
    {
        ...
        [SerializeField] private Color32 gizmoColor = new Color32(000, 179, 223, 255);
        ...
        [SerializeField, Range(1, 100)] private float range = 10;
        [LineSeparator]
        [Tooltip("List will be updated on component enable and at the point of activation")]
        [ReadOnly, SerializeField] private List<CameraRig> shakableRigs;
