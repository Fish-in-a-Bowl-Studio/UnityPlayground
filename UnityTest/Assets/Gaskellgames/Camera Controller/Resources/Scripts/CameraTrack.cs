...
namespace Gaskellgames.CameraController
{
    public class CameraTrack : MonoBehaviour
    {
        ...
        //[Header("Gizmo Settings"), Space]
        
        [SerializeField, Range(0.1f, 2)] private float nodeScale = 1f;
        [SerializeField, Range(0.1f, 2)] private float waypointScale = 1f;
        [SerializeField] private Color32 nodeColor = new Color32(000, 079, 223, 255);
        [SerializeField] private Color32 trackColor = new Color32(000, 179, 223, 255);
        
        //[Header("Options"), Space]
        
        [SerializeField] private bool gizmosOnSelected = false;
        [SerializeField] private bool showAllHandles = false;
        [SerializeField] private bool autoUpdateTrack = true;
        [SerializeField] private bool showNodes = true;
        [SerializeField] private bool element0IsOrigin = true;
        ...
        //[Header("Curve Setup"), Space]
        [LineSeparator]
        
        [ReadOnly, SerializeField] private float trackLength;
        private int selectedIndex;
        
        //[Header("Curve Setup"), Space]
        [LineSeparator]
        
        [SerializeField] private TrackTypes trackType = TrackTypes.CatmullRomSpline;
        [SerializeField, Range(0, 20)] private int subdivisions = 10;
        [SerializeField, Range(0, 1)] private float tension = 0.85f;
        [Tooltip("If element0IsOrigin is true, Element 0 is set by the object transform")]
        [SerializeField] private List<Vector3> nodes;
        [SerializeField] private bool updateTrack;
        [ReadOnly, SerializeField] private TrackData waypoints = new TrackData();
